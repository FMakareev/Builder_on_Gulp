...
//npm i --seve gulp gulp-sass gulp-autoprefixer gulp-concat gulp-cssnano gulp-rename gulp-clean gulp-notify gulp-plumber gulp-sourcemaps gulp-uglify gulp-wiredep gulp-useref browser-sync bower
...
gulp.task('watch', function() {
    ...
    gulp.watch(['src/**/*.{js,scss}', 'src/*.html']).on('change', browserSync.reload); //Перезапуск browserSynс
});
...
gulp.task('styles', function() {
    return gulp.src('src/sass/**.scss')
        ...
        .pipe(rename('main.min.css')) //Переименование
